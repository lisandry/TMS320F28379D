...
build-1006056111: ../c2000.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccs1281/ccs/utils/sysconfig_1.21.0/sysconfig_cli.bat" --script "C:/Users/lisan/IC_2025/adc_soc_dma_dac/c2000.syscfg" -o "syscfg" -s "C:/ti/c2000/C2000Ware_5_04_00_00/.metadata/sdk.json" -d "F2837xD" --compiler ccs
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/board.c: build-1006056111 ../c2000.syscfg
syscfg/board.h: build-1006056111
syscfg/board.cmd.genlibs: build-1006056111
syscfg/board.opt: build-1006056111
syscfg/board.json: build-1006056111
syscfg/pinmux.csv: build-1006056111
syscfg/c2000ware_libraries.cmd.genlibs: build-1006056111
syscfg/c2000ware_libraries.opt: build-1006056111
syscfg/c2000ware_libraries.c: build-1006056111
syscfg/c2000ware_libraries.h: build-1006056111
syscfg/clocktree.h: build-1006056111
syscfg: build-1006056111
